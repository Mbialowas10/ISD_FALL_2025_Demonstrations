...
# from grade_point_average_calculator import Listing
...
class StudentListing(Listing):
    ...
    def __init__(self):
        ...
        for student in self.students:
            ...
            grade_point_average_item = (
                QTableWidgetItem(f"{student.grade_point_average:.2f}")
            )
